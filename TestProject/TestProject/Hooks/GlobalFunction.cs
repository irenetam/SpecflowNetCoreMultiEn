...
namespace Altsource.Hooks
{
    public class GlobalFunction
    {
        ...
        //public void SendMailWithXOAUTH2(string userEmail, string accessToken)
        //{
        //    try
        //    {
        ...
        //        oMail.To = "phanthitam.90@gmail.com";
        ...
        public void SendGmail(string attachmentpath)
        {
            var smtp = new System.Net.Mail.SmtpClient
            {
                ...
                Credentials = new NetworkCredential("tampn389@gmail.com", "nhocty3890")
            };
            using (var message = new MailMessage("tampn389@gmail.com", "phanthitam.90@gmail.com")
            {
            ...
            {
                message.To.Add("phanthitam.90@gmail.com");
        ...
        public static void SendFailTestEmail(string subject, string message)
        {
            try
            {
                System.Net.Mail.SmtpClient sc = new System.Net.Mail.SmtpClient(host, Convert.ToInt32(port))
                {
                    Credentials = new NetworkCredential(fromemail, emailpassword),
                    EnableSsl = false
                };
